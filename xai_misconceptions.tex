...
% CC by 4.0 license
% TODO: 
% - replace hypotheticals with examples - see figures below
% - define human centered ML in conclusion	 
...
For a curated list of many other different types of white-box modeling techniques, and model-specific, model-agnostic, and surrogate model explainable ML techniques, please see:
...
% insert figure - use CC data marital status
...
%Much groundbreaking work has been done in several related disciplines to make machine learning more interpretable and trustworthy, and the cursory application of traditional black-box ML to human-centered problems is now an outdated, ethically problematic, and potentially dangerous practice.
